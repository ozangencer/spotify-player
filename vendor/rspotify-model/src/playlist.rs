...
pub struct FullPlaylist {
    ...
    pub public: Option<bool>,
    pub snapshot_id: String,
    #[serde(alias = "items", default = "empty_playlist_items")]
...
/// Empty page used when a playlist response carries no `tracks`/`items` field
/// (development-mode client IDs only receive items for playlists the user owns).
fn empty_playlist_items() -> Page<PlaylistItem> {
    Page {
        href: String::new(),
        items: Vec::new(),
        limit: 0,
